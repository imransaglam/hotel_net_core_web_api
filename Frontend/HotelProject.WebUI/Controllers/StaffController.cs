    ...
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode) //adresten başarılı durum kodu gelirse
            {
                ...
                var values = JsonConvert.DeserializeObject<List<StaffViewModel>>(jsonData);//json türündeki veri deserilaize edilerek tabloda gösterilecek formata dönüştürdük
                return View(values);
            }
            return View();
        }
